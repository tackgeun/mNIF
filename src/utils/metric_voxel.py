...
from src.utils.structural_losses.tf_nndistance import nn_distance
...
# https://github.com/optas/latent_3d_points/blob/master/src/evaluation_metrics.py#L33
def minimum_mathing_distance_tf_graph(n_pc_points, batch_size=None, normalize=True, sess=None, verbose=False, use_sqrt=False):
...
# https://github.com/optas/latent_3d_points/blob/master/src/evaluation_metrics.py#L90
...
# https://github.com/optas/latent_3d_points/blob/master/src/evaluation_metrics.py#L135
def coverage(sample_pcs, ref_pcs, batch_size, normalize=True, sess=None, verbose=False, use_sqrt=False, ret_dist=False):
